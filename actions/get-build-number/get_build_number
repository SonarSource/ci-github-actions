...
BUILD_NUMBER=$(gh api -H "$GH_API_VERSION_HEADER" "/repos/${GITHUB_REPOSITORY}/properties/values" \
...
gh api --method PATCH -H "$GH_API_VERSION_HEADER" "/repos/${GITHUB_REPOSITORY}/properties/values" \
